            ...
            <td class="dlg-body"><br>
               <table class="month">
                  ...
                  <tr>
                     ...
                     <td class="title-button">&nbsp;</td>
                     <?php for($idx=0; $idx<strlen($M->template); $idx++) {
                        if ( $A->get($T->template[$idx]) ) { ?>
                           <td class="day-a<?=$A->id?>">&nbsp;
                        <?php }else{
                           if ( $H->findBySymbol($M->template[$idx]) ) { ?>
                     ...
                     if ($showthisabsence) {
                        ...
                        if (TRUE) { ?>
                           ...
                           for($idx=0; $idx<strlen($M->template); $idx++) {
                              if ( $T->template[$idx] == $abs['id'] ) { ?>
                                 <td class="day-a<?=$abs['id']?>">
                                    <input name="opt-<?=$idx+1?>" type="radio" value="<?=$abs['id']?>" <?=($showdisabled?'DISABLED':'')?>>
                              <?php }else{
                                 if ( $H->findBySymbol($M->template[$idx]) ) { ?>
                                    <td class="day-<?=$H->cfgname?>">
                                 <?php }else{ ?>
