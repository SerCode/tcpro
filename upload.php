   ...
   <div id="content">
      <div id="content-content">
         <table class="dlg">
            ...
            <tr>
               <td class="dlg-body">
                  <form name="form1" enctype="multipart/form-data" method="post" action="<?=$_SERVER['PHP_SELF']?>?lang=<?=$CONF['options']['lang']?>&amp;target=<?=$_REQUEST['target']?>">
            ...
            <tr>
               <td class="dlg-menu">
                  <input name="btn_help" type="button" class="button" onclick="javascript:this.blur(); openPopup('help/<?=$CONF['options']['helplang']?>/html/index.html?upload_dialog.html','help','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,titlebar=0,resizable=0,dependent=1,width=740,height=500');" value="<?=$LANG['btn_help']?>">
